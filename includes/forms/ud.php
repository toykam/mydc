    ...
    <div class="col-md-12 row">
        ...
        <div class="form-group class undergraduate">
            <input class="form-control undergraduate" name="platoon" placeholder="Participants Platoon" />
        </div>
        </div>
        ...
        <div class="form-group class undergraduate">
            <select name="class" class="form-control undergraduate">
            <option>Select Participant's Level</option>
        ...
        <div class="form-group class undergraduate">
            <input type="text" class="form-control undergraduate" name="occupation" placeholder="Participants Occupation" />
        </div>
        </div>
        <hr/>
        <div class="col-md-4">
