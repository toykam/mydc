    ...
    <div class="col-md-12 row">
        ...
        <div class="form-group">
            <input class="form-control general" value="<?php echo ($participantData) ? $participantData['first_name'] : ''; ?>"  name="first_name" placeholder="Participants First Name" />
        </div>
        <div class="form-group">
            <input class="form-control general" value="<?php echo ($participantData) ? $participantData['last_name'] : ''; ?>"  name="last_name" placeholder="Participants Last Name" />
        </div>
        <div class="form-group">
            <!-- <label>Select Gender</label> -->
            <select name="gender" class="form-control general">
            <option selected disabled>Select Gender</option>
            <option value="male" selected="<?php echo ($participantData) ? strtolower($participantData['gender']) == 'male' : ''; ?>" >Male</option>
            <option value="female" selected="<?php echo ($participantData) ? strtolower($participantData['gender']) == 'female': ''; ?>" >Female</option>
            </select>
        </div>
        <div class="form-group">
        ...
        <div class="col-md-4">
            <h4>QRCode Number</h4>
            <div class="form-group">
                <input name="qrcode" placeholder="QRCode Number" class="form-control"value="<?php echo ($participantData != null) ? $participantData['qrcode'] : ''; ?>" />
            </div>
